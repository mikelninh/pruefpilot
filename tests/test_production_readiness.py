...
from app.production import Principal, authenticate_api_key, load_api_principals, production_readiness
from app.storage import SQLiteStore


def test_principals_parse_and_authenticate_constant_contract():
    principals = load_api_principals('{"key-a":{"tenant_id":"tenant-a","actor_id":"alice","role":"reviewer"}}')
...
def configured_env(monkeypatch):
    monkeypatch.setenv("PRUEFPILOT_API_PRINCIPALS", '{"key-a":{"tenant_id":"tenant-a","actor_id":"alice","role":"reviewer"}}')
